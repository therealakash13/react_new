...
export default function CreateTask() {
  ...
  const handleSubmit = (e) => {
    ...
    const assignToEmail = assignTo.trim().toLowerCase();

    const employeeExists = state.tasks.employees.some(
      emp => emp.email.toLowerCase() === assignToEmail
    );
    ...
    if (taskDetails.dueDate < today) return alert("Due date cannot be before today.");
  ...
  return (
    <div className="flex gap-10 bg-gray-700">
       <form
